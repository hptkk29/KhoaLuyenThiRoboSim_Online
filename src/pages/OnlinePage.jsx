      ...
      <section id="courses">
        <div className="container">
          ...
          <div className={`tab-content${tab === 'r1' ? ' active' : ''}`}>
            ...
            <div className="csum">
              {[['18','Bài học video'],['5','Module lộ trình'],['~7.5h','Tổng thời lượng'],['18','Bài kiểm tra AI'],['♾','Truy cập vĩnh viễn']].map(([n,l]) => (
          ...
          <div className={`tab-content${tab === 'r2' ? ' active' : ''}`}>
            ...
            <div className="csum">
              {[['18','Bài học video'],['5','Module lộ trình'],['~9h','Tổng thời lượng'],['18','Bài kiểm tra AI'],['♾','Truy cập vĩnh viễn']].map(([n,l]) => (
                <div className="cs" key={l}><div className="csn">{n}</div><div className="csl">{l}</div></div>
              ))}
            </div>
          </div>
