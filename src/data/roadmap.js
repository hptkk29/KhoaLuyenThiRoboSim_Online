const roadmap = [
  {
    ...
    summary: 'Đầu chặng: Con bỡ ngỡ. Cuối chặng: Con đã hiểu rõ "đề trông ra sao" và "thi như thế nào".',
  },
  {
    id: 2,
    colorKey: 'yellow',
    ...
    intro: 'Đây là chặng DÀI NHẤT — và cũng là chặng CỐT LÕI nhất. Con thực hành trực tiếp với chính đề thi vòng loại đã mở:',
    points: [
